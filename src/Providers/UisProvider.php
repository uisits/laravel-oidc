...
class UisProvider extends AbstractOidcProvider
{
    /**
    ...
    {
        $clientId = config('shibboleth-oidc.providers.uis.introspect.client_id');
        $clientSecret = config('shibboleth-oidc.providers.uis.introspect.client_secret');
